...
export class FocusHelper {
     ...
     */
    @observable
    private getFocusedBlockPosition = (
    ...
    public getFocusArea(zoomIn: number, plannerCanvasSize: Size) {
        return {
            x: plannerCanvasSize.width * zoomIn,
            y: plannerCanvasSize.height * zoomIn,
        };
    }
            ...
            if (this.plan.focusedBlock.id === block.id) {
                ...
                point = this.getFocusedLinkedBlockPosition(
                    ...
                    providingBlocks.filter(
                        ...
                        : ResourceRole.CONSUMES,
                    positioningData,
                    { providingBlocks, consumingBlocks, all },
                    nodeSize
                );
            }
     ...
     */
    @observable
    private getFocusedLinkedBlockPosition(
        blockId: string,
        side: ResourceRole,
        positionData: FocusPositioningData,
        allBlocks: NeighboringBlocks,
        nodeSize: PlannerNodeSize
    ): Point {
