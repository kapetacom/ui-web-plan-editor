                    ...
                    return (
                        <div key={block.id + index}
                            ...
                            <div className="block-name">{block.name} </div>
                            {
                                ...
                                [...block.getResources(ResourceRole.CONSUMES), ...block.getResources(ResourceRole.PROVIDES)].map((resource: PlannerResourceModelWrapper,ix) => {
                                    return (
                                        <div key={`resource_${ix}`}
                                             onMouseMove={() => {
