...
const PlannerBlockWarningTag = (props: PlannerBlockWarningTagProps) => {
    ...
    return (
        <svg x="88" y="5" fill="none" filter={"url(#banner-shadow)"} >
            ...
            {props.show &&
                <>
                    <path id={warningTag} className="warning-tag" x="20" y="20" d={SVGCornersHelper.createRoundedPathString(INITIAL_POINTS, 5)} />
                    <svg id={warningTagSign} y="12" x="4" opacity="1" viewBox="0 0 100 100 " overflow="visible" >
