...
class PlannerBlockResourceList extends Component<PlannerBlockResourceListProps, any> {
    ...
    showPlaceholder() {
        ...
        if (this.props.role === ResourceRole.CONSUMES &&
    ...
    render() {
        ...
        const placeholderX = this.props.role === ResourceRole.PROVIDES ? this.props.blockData.width + offsetX : -placeholderWidth;
        ...
        return (
            <svg
                ...
                <svg className={'resource-placeholder'}
                     x={placeholderX} y={resourceRight * this.props.list.length}>
                    <rect height={resourceRight - 4}
