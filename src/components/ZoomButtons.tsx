...
export const ZoomButtons = (props:Props) => {
    ...
    return <svg className="zoom-buttons" x="50" y="50" overflow="visible" height="20" width="40">
        <svg width="45" height="45" viewBox="0 0 45 45" fill="none" onClick={props.onZoomIn}>
            <path
        ...
        <svg className={zoomResetClassName} width="45" height="45" viewBox="0 0 45 45" x="35" y="-20" fill="none"
