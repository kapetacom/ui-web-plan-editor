            ...
            <DragAndDrop.ContextProvider>
                ...
                <PlannerCanvas>
                    {instances.map((instance, index) => {
                        ...
                        return <BlockContextProvider key={instance.id} blockId={instance.id}>
                            <PlannerBlockNode
                                size={nodeSize}
                    ...
                    {connections.map((connection) => {
                        ...
                        let className = toClass({
                            'connection-hidden': !!(focusInfo?.focus && !isConnectionTo(connection, focusInfo?.focus.instance.id))
                        })
